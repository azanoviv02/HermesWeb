...
@DiscriminatorValue("ABSTRACT_ACCOUNT")
public abstract class AbstractAccount extends AbstractPersistentObject {
    ...
    AbstractAccount(String login, String password, String name, Role role) {
        this.login = login;
